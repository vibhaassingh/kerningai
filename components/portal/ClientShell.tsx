...
const PORTAL_NAV: SidebarSection[] = [
  ...
  },
  {
    title: "03 — Workspace",
    items: [
      { number: "09", href: "/portal/onboarding", label: "Onboarding", disabled: true, badge: "Phase 3" },
      { number: "10", href: "/portal/reports", label: "Reports", disabled: true, badge: "Phase 4" },
      { number: "11", href: "/portal/documents", label: "Documents", disabled: true, badge: "Phase 2" },
      { number: "12", href: "/portal/support", label: "Support", disabled: true, badge: "Phase 2" },
      { number: "13", href: "/portal/team", label: "Team", disabled: true, badge: "Phase 2" },
      { number: "14", href: "/portal/settings/security", label: "Security Settings" },
    ],
  },
];
